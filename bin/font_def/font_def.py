...
for chars in char_map.keys():
    #hex_values = [0x0, 0x6, 0xf, 0x6, 0x0]
    hex_values = char_map[chars]
    binary_representation = ''.join(format(value, '04b') for value in hex_values)
    print(chars, list(binary_representation))  # Output: "00000110111101100000"
